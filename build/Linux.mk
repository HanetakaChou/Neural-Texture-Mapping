...
$(BIN_DIR)/Neural-Texture-Mapping: $(OBJ_DIR)/Neural-Texture-Mapping-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so
	...
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/Neural-Texture-Mapping-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so -lxcb -lxcb-present -o $(BIN_DIR)/Neural-Texture-Mapping
...
# Compile
$(OBJ_DIR)/Neural-Texture-Mapping-inference-main.o: $(CODE_DIR)/inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/inference-main.cpp -MD -MF $(OBJ_DIR)/Neural-Texture-Mapping-inference-main.d -o $(OBJ_DIR)/Neural-Texture-Mapping-inference-main.o
